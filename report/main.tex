...
\alttitle{Utvärdering av olika träningstekniker för ett konvolutionellt neuralt nätverk som klassificerar Alzheimers sjukdom}
...
\begin{flalign*}
  \begin{aligned}
    ...
    \end{cases} & \\[5pt]
    \text{where }x &= \frac{\text{day}_{\text{MRI}} - \text{day}_\text{prev}}{\text{day}_{\text{next}} - \text{day}_{\text{prev}}}&
  \end{aligned}
\end{flalign*}
