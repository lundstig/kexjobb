...
Clinical dementia rating (CDR) is a score that is used to classify the stage of Alzheimer’s disease. Stages 0.0 through 2.0 is described in Table~\ref{tab:cdr_definition}. There also exists a final stage (3.0)~\cite{cdr}. This is not relevant to this study, as the disease in this stage is too severe to partake in medical studies.
\begin{table}[h]
  \renewcommand{\arraystretch}{1.2}
  \begin{center}
    ...
    \begin{tabular}{c|ll}
      ...
      \toprule
      0.0 & None & No systematic and \\
      0.5 & Questionable & \hl{TODO} \\
      1.0 & Mild & \hl{TODO} \\
