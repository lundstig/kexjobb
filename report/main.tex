...
Alzheimer’s Disease (AD) is a neurodegenerative disease that is the leading cause of dementia. Currently there is no cure for the disease, it can only be slowed down. Early detection is therefore very important as it could significantly improve the prognosis for a patient.
